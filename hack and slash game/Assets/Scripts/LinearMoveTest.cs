...
public class LinearMoveTest : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        */
        ...
        _rb.velocity = new Vector3(finalDirection.x *Time.deltaTime, _rb.velocity.y + (Physics.gravity.y * gravityMod), finalDirection.z * Time.deltaTime);
